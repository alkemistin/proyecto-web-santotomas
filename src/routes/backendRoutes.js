...
const { ingresarCliente, listarClientes, editarCliente, guardarEdicion, guardarNuevoCliente } = require('../controllers/backend/clientesController');
...
router.post('/modulo-ingresar-cliente', authMiddleware, guardarNuevoCliente)
